...
class Network(tnn.Module):
    def __init__(self):
        ...
        hidden_dim = 128
        input_dim = 50
        #improve LSTM by feeding the last layer into a 2nd layer
        #aswell as adding bidirectional option
        self.lstm = tnn.LSTM(input_dim, hidden_dim, num_layers = 2, bidirectional = True, dropout = 0.3, batch_first = True)
        self.ih2 = tnn.Linear(hidden_dim, 64)
    ...
    def forward(self, input, length):
        ...
        new_h = new_h[-1, :, :]     #take out last hidden layer
        new_h = new_h.reshape(-1)   #makesure output is 1d [batch size]
        return new_h
